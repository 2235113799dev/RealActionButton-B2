...
- (void)viewDidLoad{[super viewDidLoad];_query=@"";self.tableView.rowHeight=44.0;self.tableView.estimatedRowHeight=44.0;_apps=ABMCActionApplicationRecords();[self refreshHeader];}
